          ...
          <div class="card-body p-md-5">
            <div class="row justify-content-center">
              <div class="col-md-6 col-lg-8 col-xl-10">
                ...
                <form class="mx-1 mx-md-4" id="userLoginForm">
                  ...
                  <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                    <input type="submit" value="Submit" id="user-login-btn" class="btn btn-primary btn-lg btn-block" disabled="disabled">
                  </div>
...
$('input').on('input',function(e){
   if($('#userLoginForm').find('.valid-input').length==2){
       $('#user-login-btn').removeClass('allowed-submit');
       ...
       $("#user-login-btn").click(function(e){
         ...
         $.ajax({
               type: "POST",
               url: "./main/code.php",
               data: $("#userLoginForm").serialize()+'&user_action=user_login',
