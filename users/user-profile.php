...
$get_profile_data=getUserProfile($conn,$_SESSION['USER_ID']);
...
<label>Name</label>
<input type="text" name="name" class="form-control" placeholder="Update Name" value="<?=$data['user_name']?>">
</div>
<div class="form-group">   
<label>Email</label>
<input type="email" class="form-control" name="email" placeholder="Update Email" value="<?=$data['user_email']?>">
</div>
<div class="form-group">
<label>Phone Number</label>
<input type="text" class="form-control" name="phone_number" placeholder="Update Number" value="<?=$data['user_pnumber']?>">
</div>
<div class="form-group">
<label>Profile Image</label>
<div class="media align-items-center">
<div class="media-left">
<img class="rounded-circle profile-img avatar-view-img" src="../assets/images/userimage/<?=$data['user_image']?>" alt="" width="100" height="100">
</div>
...
<div class="form-group">
  <input type="hidden" name="old_image" value="<?=$data['user_image']?>"> 
</div>     
</div>
</div>
</div>
...
<input type="password" name="current_password" id="current_password" class="form-control" value="<?=$data['user_password']?>">
</div>
<div class="form-group">
